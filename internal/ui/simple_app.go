...
func NewSimpleApp() SimpleApp {
	...
	cosmosInput.Placeholder = "https://cosmos-rpc.polkachu.com"
	cosmosInput.Width = 80
	
	// EVM RPC input
	evmInput := textinput.New()
	evmInput.Placeholder = "https://eth.llamarpc.com"
	evmInput.Width = 80
	...
	case tea.KeyMsg:
		...
		case "enter":
			...
			case 1: // Cosmos RPC step
				...
				if cosmosRPC == "" {
					cosmosRPC = "https://cosmos-rpc.polkachu.com"
				}
